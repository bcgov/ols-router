...
In year two (ending March 2020), we added support for truck routing which takes vehicle and load dimensions and road restrictions into account. This version of the BC Route Planner is now incorporated into the [TransLink Route Planner](https://translink.apps.gov.bc.ca/trp/) which is an interactive,easy to understand trip-planning application for goods movement in Metro Vancouver. It improves on existing regional way-finding and trip planning tools, which was identified as an implementation priority in the [TransLink Regional Goods Movement Strategy] (https://www.translink.ca/Plans-and-Projects/Roads-Bridges-and-Goods-Movement-Projects/Goods-Movement-Initiatives).
