...
Ferry schedules|No|Good|GTFS files from BC Ferries and Ministry of Transportation|Suitable for demo only; BC Ferries doesn't provide GTFS so we created a GTFS file for winter schedules of Bowen Island and added support for Barnston Island Ferry (MOTI)
