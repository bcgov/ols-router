...
5. Simplify driving directions using the *simplifyDirections* and *simplityThreshold* parameters
6. Enhanced route partitioning to include distance per partition
7. Include a list of all restriction IDs impacting the direction of travel along a route.
8. Specify the source of road restrictions. Options include ITN (Integrated Transportation Network) or RDM (Restriction Data Manager)
