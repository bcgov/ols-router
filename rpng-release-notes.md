...
Hard road restrictions|Yes|Acceptable; basic single-value, minimum height and weight restrictions are supported; no support for height/weight restrictions by lane or rig type|road minimum height and weight(GVW) from ITN<br>road width|height and weight: Good in Metro Vancouver, poor elsewhere<br>width,length: no data in ITN, demo data only
