...
Historic traffic congestion|Yes|Demo only. In the absence of real data, simulated traffic peaks were generated (rush hour)|historic traffic data for each road segment in urban areas|Poor; just fake data for demos
