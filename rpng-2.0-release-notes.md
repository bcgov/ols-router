...
For more information about the API, consult the [Route Planner Developer Guide](https://github.com/bcgov/ols-router/gh-pages/blob/master/router/router-developer-guide.md)
