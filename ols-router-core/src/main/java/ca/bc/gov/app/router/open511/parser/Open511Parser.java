 ...
 *  All rights reserved.
 */
package ca.bc.gov.app.router.open511.parser;
...
import ca.bc.gov.app.router.open511.Area;
import ca.bc.gov.app.router.open511.Event;
import ca.bc.gov.app.router.open511.EventResponse;
import ca.bc.gov.app.router.open511.Meta;
import ca.bc.gov.app.router.open511.Pagination;
import ca.bc.gov.app.router.open511.RecurringSchedule;
import ca.bc.gov.app.router.open511.Restriction;
import ca.bc.gov.app.router.open511.Road;
import ca.bc.gov.app.router.open511.Schedule;
import ca.bc.gov.app.router.open511.ScheduleInterval;
import ca.bc.gov.app.router.open511.enums.Direction;
import ca.bc.gov.app.router.open511.enums.EventCertainty;
import ca.bc.gov.app.router.open511.enums.EventSeverity;
import ca.bc.gov.app.router.open511.enums.EventStatus;
import ca.bc.gov.app.router.open511.enums.EventSubtype;
import ca.bc.gov.app.router.open511.enums.EventType;
import ca.bc.gov.app.router.open511.enums.ImpactedSystem;
import ca.bc.gov.app.router.open511.enums.RestrictionType;
import ca.bc.gov.app.router.open511.enums.RoadState;
import ca.bc.gov.app.router.open511.enums.ScheduleException;
